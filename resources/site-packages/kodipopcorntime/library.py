...
def library_add(content_type):
    ...
    import xbmc
    import xbmcgui
    from kodipopcorntime.magnet import ensure_magnet, display_name
    from kodipopcorntime.utils import get_show_info_from_name
    ...
    for name, entry in LIBRARY_PATHS.items():
        if entry["strContent"] == content_type:
            ...
            if not filename:
                plugin.notify(plugin.addon.getLocalizedString(30303))
                return

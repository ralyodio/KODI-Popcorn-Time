...
def get_yifysubs_item(imdb_id):
    ...
    if data.has_key(SUBLANG_EN_1):
        suburl = "%s%s" % (BASE_URL, data[SUBLANG_EN_1][0]["url"])
        sublang = SUBLANG_ISO_1
    elif data.has_key(SUBLANG_EN_2):
        suburl = "%s%s" % (BASE_URL, data[SUBLANG_EN_2][0]["url"])
        sublang = SUBLANG_ISO_2
    elif data.has_key(SUBLANG_EN_3):
        suburl = "%s%s" % (BASE_URL, data[SUBLANG_EN_3][0]["url"])
